...
// Porting BY EMI INDO with c3addon-ide-plus
{
    ...
    const PLUGIN_ID = "EMI_INDO_plugin_android_imei";
    // callMap Deprecated const PLUGIN_VERSION = "1.0.0.0";
    const PLUGIN_CATEGORY = "platform-specific";

    const SDK = globalThis.SDK;
    const PLUGIN_CLASS = SDK.Plugins.EMI_INDO_plugin_android_imei = class plugin_android_imeiPlugin extends SDK.IPluginBase {
        constructor() {
            super(PLUGIN_ID);
